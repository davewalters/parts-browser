...
class InventoryRecords(InventoryRecordsTemplate):
  def __init__(self,
    ...
    self.repeating_panel_inventory.set_event_handler("x-status_transfer", self.status_transfer)
    self.repeating_panel_inventory.set_event_handler("x-bin_transfer", self.bin_transfer)
  ...
  def status_transfer(self, part_summary, **event_args):
  ...
  def bin_transfer(self, part_summary, **event_args):
    open_form("InventoryBinTransfers",
              inventory_part_id=part_summary["part_id"],
              prev_filter_part_id=self.text_box_part_id.text,
              prev_filter_part_name=self.text_box_part_name.text,
              prev_filter_kanban=self.check_box_kanban.checked)
